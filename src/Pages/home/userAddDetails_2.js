...
const UserAddDetails_2 = ({ onPress, discriptionStyle, imgsource, TitleStyle, Title, imgsrc, rateStyle, discription, name, rate, nameStyle }) => {
    return (
        <View>
            ...
            <TouchableOpacity onPress={onPress} style={{ backgroundColor: '#fff', marginHorizontal: 10, marginEnd: 5, borderRadius: 10, }}   >
                <View style={{ flexDirection: "row" }}>
                    ...
                    <View>
                        <View style={{ marginHorizontal: 15, marginTop: 50, width: "65%" }}>
...
export default UserAddDetails_2
