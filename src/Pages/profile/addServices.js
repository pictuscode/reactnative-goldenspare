...
const AddServices = ({ route }) => {
    ...
    const [checkBoxselectedList, setCheckBoxSelectedList] = useState(serviceId.serviceId)
            ...
            <ScrollView keyboardDismissMode="on-drag"
                ...
                <View style={{ marginHorizontal: 20 }}>
                    ...
                    <View style={{ width: '80%', marginEnd: 20, marginBottom: 5, }} >
                        ...
                        <ThemeButton name="Add Services" styleText={Style.themebtn_text} styleButton={Style.themebtn} onPressFun={() => { CheckBoxCheck() }}></ThemeButton>
