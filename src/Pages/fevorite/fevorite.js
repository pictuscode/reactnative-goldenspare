...
import { View, ActivityIndicator, FlatList, TouchableOpacity, Image, Text, ToastAndroid, ScrollView } from 'react-native'
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            ...
                            <View style={{ marginStart: 10, width: 200 }}>
                                ...
                                <View style={{ marginBottom: 5 }}>
                                    ...
                                    <ThemeButton name="View" styleText={Profilestyle.themebtn_text} styleButton={Profilestyle.themebtn} onPressFun={() => { navigation.navigate("Categoriesdetails", { Id: item._id }) }}></ThemeButton>
                                </View>
