...
import { FONT_WHITE, FONT_BLACK, BG_COLOR } from '../../Components/Common/Variable';
...
const Categoriesdetails = ({ route }) => {
    ...
    const Details = () => (
        ...
        <ScrollView style={{ height: Dimensions.get('window').height, marginTop: 20 }} showsVerticalScrollIndicator={false} onScroll={newHandler} >
    ...
    const handleScroll = (event) => {
        ...
        if (event.nativeEvent.contentOffset.y > 270) {
            setScrollEnabled(false);
        }
    ...
    return (
        <>
            ...
            <ScrollView onScroll={handleScroll} style={{ width: "100%", height: Dimensions.get('window').height, }} decelerationRate={0} showsVerticalScrollIndicator={false} scrollEnabled={scrollEnabled} >
                <View style={{ backgroundColor: FONT_WHITE, height: 300, }}>
                    <View style={{ alignItems: 'center', marginTop: 20, }}>
                        ...
                        <View style={{ flexDirection: 'row', margin: 10, marginStart: 50 }}>
                            <View style={{ marginTop: 12, marginStart: 12 }}>
                                <Svg
                            ...
                            <View style={{ marginStart: 5, flexDirection: "row" }} >
                                ...
                                <View style={{ width: '40%', }}>
                                    <ThemeButton name="Chat " styleText={Style.themebtn_text} styleButton={Style.themebtnsml} onPressFun={() => { navigation.navigate("Chat", { Id: toId.Id }) }}></ThemeButton>
                                </View>
                            </View>
                        </View>
                    </View>
                ...
                <View style={{ height: Dimensions.get('window').height, backgroundColor: FONT_WHITE, }}  >
                    <TabView
    ...
    return (
        ...
        <View style={{ flex: 1, height: 940 }}>
            ...
            >
                ...
                <View style={{ flex: 1, height: 670, backgroundColor: BG_COLOR }} >
